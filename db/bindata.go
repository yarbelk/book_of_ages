...
func migrations01_initialSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/01_initial.sql", size: 1282, mode: os.FileMode(436), modTime: time.Unix(1444023123, 0)}
